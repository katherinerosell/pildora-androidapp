...
public class AddMedicationFragmentTest {
    ...
    //private static final Intent MY_ACTIVITY_INTENT = new Intent(getTargetContext(), MainActivity.class);
    @Before
    ...
    /**
     * Attach the values to the EditText objects
    ...
    /**
     * Check if the database actually saved the prescription information!
     */
    @Test
